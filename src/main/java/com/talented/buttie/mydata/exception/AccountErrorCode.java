...
public enum AccountErrorCode implements BaseErrorCode {
    ...
    ACCOUNT_CREATE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "ACCOUNT_003", "계좌 등록에 실패했습니다."),
    ACCOUNT_UPDATE_FAILED(HttpStatus.NOT_FOUND, "ACCOUNT_004", "수정할 계좌 정보를 찾을 수 없습니다.");
