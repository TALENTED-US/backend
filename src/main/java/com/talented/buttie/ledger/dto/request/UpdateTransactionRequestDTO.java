...
@ApiModel(description = "수동 거래 목록 수정 요청")
@Builder
public record UpdateTransactionRequestDTO(
    ...
    @ApiModelProperty(value = "카테고리", example = "FOOD", required = true)
    @NotNull(message = "지출 카테고리 선택은 필수입니다.")
    ExpenseCategory expenseCategory,

    @ApiModelProperty(value = "거래일시", example = "2026-07-28T00:00:00", required = true)
