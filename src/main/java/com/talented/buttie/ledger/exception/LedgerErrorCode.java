...
public enum LedgerErrorCode implements BaseErrorCode {
    ...
    EXTERNAL_TRANSACTION_UNMODIFIABLE(HttpStatus.FORBIDDEN, "LEDGER_006", "외부 기관에서 연동된 거래는 금액, 카테고리, 일시를 수정할 수 없습니다. (메모만 수정 가능)"),
    EXTERNAL_TRANSACTION_UNDELETABLE(HttpStatus.FORBIDDEN, "LEDGER_007", "외부 기관에서 연동된 거래는 삭제할 수 없습니다."),
    FIXED_EXPENSE_NOT_FOUND(HttpStatus.NOT_FOUND, "LEDGER_008", "등록된 고정 지출 내역을 찾을 수 없습니다.");
