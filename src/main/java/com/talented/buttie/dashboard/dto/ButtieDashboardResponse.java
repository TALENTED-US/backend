...
public record ButtieDashboardResponse(
    ...
    @ApiModelProperty(value = "누적 경험치", example = "19", required = true)
    ...
    @ApiModelProperty(value = "현재 자금으로 버틸 수 있는 개월 수", example = "1.9", required = true)
    ...
    @ApiModelProperty(value = "목표 취업일", example = "2027-01-01", required = true)
