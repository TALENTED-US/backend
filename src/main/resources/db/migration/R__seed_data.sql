...
(`TRANSACTION_ID`, `USER_ID`, `ACCOUNT_ID`, `EXTERNAL_TRANSACTION_ID`, `TRANSACTION_CONTENT`,
 ...
 `IS_DELETED`) VALUES
(1, 1, 1, 'EXT_TX_001', '스타벅스 강남점',        'EXPENSE', 'FOOD',          6300,   '2026-07-20 10:15:00', NULL, FALSE),
(2, 1, 1, 'EXT_TX_002', '지하철 교통카드',        'EXPENSE', 'TRANSPORT',     1400,   '2026-07-20 08:40:00', NULL, FALSE),
(3, 1, 1, 'EXT_TX_003', '월세 이체',              'FIXED',   'HOUSING',       500000, '2026-07-01 09:00:00', '원룸 월세(고정지출)', FALSE),
(4, 1, 1, 'EXT_TX_004', '넷플릭스 정기결제',      'FIXED',   'SUBSCRIPTION',  9900,   '2026-07-05 00:10:00', '구독(고정지출)', FALSE),
(5, 1, 1, 'EXT_TX_005', '토익 응시료',            'EXPENSE', 'EDUCATION',     48000,  '2026-07-12 13:00:00', NULL, FALSE),
(6, 1, 1, 'EXT_TX_006', '편의점 아르바이트 급여', 'INCOME',  'ETC_EXPENSE',   480000, '2026-07-10 18:00:00', '7월 알바 급여', FALSE),
(7, 1, 1, 'EXT_TX_007', '통신비 자동이체',        'FIXED',   'COMMUNICATION', 55000,  '2026-07-05 09:00:00', '휴대폰 요금(고정지출)', FALSE),
(8, 1, NULL, NULL, '현금 식비(수동 등록)', 'EXPENSE', 'FOOD', 8000, '2026-07-21 12:30:00', '학식', FALSE)
ON DUPLICATE KEY UPDATE
...
(1, 1, 'INCOME',  '편의점 알바', NULL, 550000, '2026-08-01', '2026-12-23',
 NULL, 'MONTHLY', FALSE),
